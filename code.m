...
%% visualization of nouns FMRI signals 
for num=1:TrialNum
data71(num,:)=data{num, 1};
data7(num,:)=data71(num,1:voxels);

% for ploting initial FMRIs note the next lines
...
%% distiguish between test and train datas
Ftrain=zeros(25,58);
Ftest1=zeros(25,1);
Ftrain(:,1:51)=Fw(:,1:51);
Ftest1(:,1)=Fw(:,52);
...
%% linear model fitting and error calculation
